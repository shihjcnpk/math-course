...
∴ 8k·AC = 3k·(AC+10) → 8AC=3AC+30 → 5AC=30 → AC=6`,hint:`用面积法——角平分线到两边距离相等，把△ABC拆成两个小三角形。`,difficulty:`basic`,flaggedConceptIds:[`angle-bisector-properties`,`triangle-basics`]},{id:`ex-26-basic-4`,question:`已知线段AB=6cm。(1)用尺规作AB的垂直平分线l；(2)在l上任取一点P，比较PA与PB。`,answer:`(1) 分别以A、B为圆心、取大于3cm的相等半径画弧，得到两个交点；连接两交点所得直线l就是AB的垂直平分线。
(2) PA=PB，因为线段垂直平分线上的点到线段两端距离相等。`,hint:`保留两组圆弧；第(2)问直接使用垂直平分线性质。`,difficulty:`basic`,flaggedConceptIds:[`angle-bisector-properties`,`pythagorean-theorem`]},{id:`ex-26-basic-5`,question:`判断正误并改正：(1)"角平分线上的点，到角的两边任意两点距离相等。"(2)"到线段两端距离相等的点只有一个。"`,answer:`(1) 错误。改正："角平分线上的点，到角的两边的垂直距离（垂线段长度）相等。"任意两点不等于垂足。
...
∵ D在BD上，∴ DA=DC（同理）`,hint:`AC⊥BD且OA=OC→BD是AC的垂直平分线。套性质一步得出。`,difficulty:`intermediate`,flaggedConceptIds:[`angle-bisector-properties`]},{id:`ex-26-inter-3`,question:`如图，在Rt△ABC中，∠C=90°，AD平分∠BAC，DE⊥AB于E。求证：CD=DE。`,answer:`因为∠C=90°，所以DC⊥AC；又DE⊥AB。点D在∠BAC的平分线AD上，因此D到角两边AB、AC的距离相等，即DE=DC。`,hint:`先确认DC、DE都是点D到∠BAC两边的垂直距离，再使用角平分线性质。`,difficulty:`intermediate`,flaggedConceptIds:[`angle-bisector-properties`,`pythagorean-theorem`]}],challenge:[{id:`ex-26-challenge-1`,question:`（2022北京中考改编）如图，在△ABC中，∠B=2∠C，AD平分∠BAC交BC于D。求证：AC=AB+BD。`,answer:`证明（截长法）：
在AC上取点E，使AE=AB，连接DE。
∵ AD平分∠BAC，∴ ∠BAD=∠EAD。
