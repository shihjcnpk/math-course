...
import type { TypicalQuestion } from '@/types'
import MathText from '@/components/shared/MathText'

interface Props { questions: TypicalQuestion[] }

export default function ExampleSection({ questions }: Props) {
...
function QuestionCard({ question: q }: { question: TypicalQuestion }) {
